...
ActiveRecord::Schema[7.0].define(version: 2023_09_01_073408) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "subscribed_to_daily_planning", default: false
    t.boolean "subscribed_to_advices", default: true
